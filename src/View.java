...
public class View extends JFrame{
    ...
    public boolean ValidateChiffre() {
        try {
            if (Integer.parseInt(chiffreTextField.getText()) < 1 || Integer.parseInt(chiffreTextField.getText()) > 12 || chiffreTextField.getText().isEmpty()){
    ...
    public void showError() {
        JOptionPane.showMessageDialog(this, "Invalid mounth, it should be a number between 1 and 12", "Error", JOptionPane.ERROR_MESSAGE);
    }
}